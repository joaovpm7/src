...
public class LeituraDadosTeclado {
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite seu primeiro nome, idade, quantidade de filhos, altura e se tem bicinho de estimação");
		String primeiroNome = scan.next();
		int idade = scan.nextInt();
		...
		System.out.println("Seu bicinho de estimação? " + temPet);
